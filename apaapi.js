...
ApiHelper.ProductsList.prototype.getProductTitles = function () {
    return this.getProductInfo('Title');
}

ApiHelper.ProductsList.prototype.getProductAsins = function () {
    ...
    if (productInfo.ItemAttributes) {
        ...
        if (productInfo.ItemAttributes.Creator) {
            ...
            if (productInfo.ItemAttributes.Creator instanceof Array) {
                ...
                productInfo.ItemAttributes.Creator.forEach(function (creator) {
                    product.Creator.push(creator._)
                });
            } else {
                product.Creator = productInfo.ItemAttributes.Creator._;
            }

        } else if (productInfo.ItemAttributes.Author) {
            product.Creator = productInfo.ItemAttributes.Author;
        }
        if (productInfo.ItemAttributes.Feature) {
            ...
            if (productInfo.ItemAttributes.Feature instanceof Array) {
                ...
                product.Feature = productInfo.ItemAttributes.Feature;
            }
